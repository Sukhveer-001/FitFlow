  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex items-center justify-center gap-4">
        <p className="text-3xl sm:text-4xl md:text-5xl font-bold text-slate-400">
          {index}
        </p>
        ...
        {Object.keys(WORKOUTS).map((type, typeIndex) => {
          return (
            <button
              ...
              key={typeIndex}
              className={
                "bg-slate-950 border-2 border-solid py-3 rounded-lg duration-200 hover:border-blue-600" +
